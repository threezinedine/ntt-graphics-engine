...
typedef ntt_Result (*ntt_Array_Destructor)(void* pElement);
...
struct ntt_Array
{
	...
	ntt_Array_Destructor destructor; // The destructor function for the elements in the array, this is used for properly
};
 ...
 *
 * @param pArray The array to be resized, this should be a valid array created by ntt_Array_Create,
 ...
 *      ntt_Array_Create, and it should not be NULL.
 ...
 *
 * @param pArray The array to be cleared, this should be a valid array created by ntt_Array_Create, and it should
 * 		not be NULL.
 ...
 *
 * @param pArray The array to be destroyed, this should be a valid array created by ntt_Array_Create,
 *      and it should not be NULL.
 */
